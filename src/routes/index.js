...
indexRouter.get('/', TokenAuthenticator.tokenAuthenticate, IndexController.index);
indexRouter.get('/login', IndexController.login);
indexRouter.post('/login', TokenAuthenticator.tokenAuthenticate, IndexController.authenticate);
